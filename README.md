...
## 📂 Documentos Anexos
- [BDD - Testes]([BUG-BANK/blob/main/BDD.pdf](https://github.com/OtavioRdR/BUG-BANK/blob/main/%F0%9F%93%8C%20BDD.pdf)): Documento com a descrição dos cenários de teste (Behavior Driven Development).
